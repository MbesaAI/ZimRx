...
const messages = {
  en: {
    ...
    NOT_A_PRESCRIPTION: `❌ This doesn't look like a medical prescription.\n\nI can only process prescription forms from a doctor. Invoices, quotations, receipts, and other documents cannot be processed.\n\nPlease send a clear photo of your prescription from a doctor or clinic.`,
  ...
  sn: {
    MENU: `Mauya ku *ZimRx* 🏥\n\nNdinogona kukubatsira neTsamba YeMushonga yako. Chii chaunoda?\n\n*1* — 📋 Verenga Tsamba YeMushonga yangu\n*2* — 💊 Tsanangura mishonga yangu\n*3* — 🗺️ Tsvaga chemist iri pedyo\n*4* — 📁 Bvisa Tsamba YeMushonga yangu yekupedzisira\n\nKana tumira *mufananidzo* weTsamba YeMushonga yako kutanga.\n\nRidza *0* kuti ushintse mutauro.`,
    FULFILLMENT_PROMPT: `💊 *Mubvunzo — makwanisa kupinda nezvidhaka zveTsamba YeMushonga iyi here?*\n\n*1* — Hongu, ndatora mishonga yangu ✅\n*2* — Kwete, ndicharamba nditsvaga 🔍\n*3* — Kwete, handina kuwana ❌`,
    SCANNING: `📷 Ndatora mufananidzo weTsamba YeMushonga. Ndinorangarira zvino...`,
    NOT_A_PRESCRIPTION: `❌ Uyu hausi Tsamba YeMushonga yechiremba.\n\nNdinogona chete kuona mifananidzo yeTsamba YeMushonga yechiremba. Invoisi, quotation, risiti, uye zvimwe zvinyorwa hazvigonekwi.\n\nNdapota tumira mufananidzo wakajeka weTsamba YeMushonga wakapiwa nechiremba kana chipatara.`,
    ...
    SEND_PHOTO: `📸 Ndapota tumira mufananidzo weTsamba YeMushonga yako ndikuverenga.`,
    NO_PRESCRIPTION_YET: `⚠️ Hapana Tsamba YeMushonga yawanwa. Ndapota tumira mufananidzo weTsamba YeMushonga yako kutanga.`,
    ...
    NO_RECORD: `📭 Hapana Tsamba YeMushonga isevhiwa.\n\nTumira mufananidzo weTsamba YeMushonga yako kutanga.`,
    LANGUAGE_CHANGED: `✅ Mutauro washandurwa kuChiShona. Mehu yako iri pano:`,

    prescriptionDetected: (drugList) => `✅ *Tsamba YeMushonga yawanwa:*\n\n${drugList}`,
    ...
    lastPrescription:     (date, drugs) => `📁 *Tsamba YeMushonga yako yekupedzisira (${date}):*\n\n${drugs}`,
  ...
  nd: {
    ...
    NOT_A_PRESCRIPTION: `❌ Lokhu akulona isitifiketi sokwelashwa.\n\nNgingahlola izithombe zezitifiketi zebhizinisi elingumuntu wokunakekelwa kwezempilo kuphela. Imininingwane ye-invoice, quotation, receipt, nezinye izincwadi angikwazi ukuzisebenza.\n\nSicela uthumele isithombe esicacile sesitifiketi sakho esiphuma kudokotela noma esibhedlela.`,
